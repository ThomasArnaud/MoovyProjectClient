...
<c:set var="_page_current" value="directors_list" scope="request" />
<t:layout>
    <jsp:attribute name="_page_title">Moovy &raquo; Réalisateurs</jsp:attribute>
    <jsp:attribute name="body_title">Liste des réalisateurs</jsp:attribute>
    ...
    <jsp:attribute name="_page_scripts">
        ...
        <script type="text/javascript">
            $(function() {
                var directorsDataTable = $("#table-directors").dataTable({
                    language: {
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="table-directors">
                        <thead>
                            <tr>
                                <th>
                                    Prénom
